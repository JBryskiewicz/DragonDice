  ...
  <div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
      ...
      <div class="navbar-nav w-100">
        <a href="/auth/signin" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Sign in</a>
        <a href="/auth/signup" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Sign up</a>
      </div>
    </nav>
  </div>
  <!-- Sidebar End -->
